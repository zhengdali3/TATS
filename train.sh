python scripts/train_transformer.py --num_workers 32 --val_check_interval 0.5 --progress_bar_refresh_rate 500 \
                        ...
                        --vqvae /home/ubuntu/git/TATS/vqgan_ucf_128_488_epoch=1-step=29999.ckpt --data_path /home/ubuntu/Downloads/UCF-101 --default_root_dir /home/ubuntu/git/TATS/train_ckpt \
